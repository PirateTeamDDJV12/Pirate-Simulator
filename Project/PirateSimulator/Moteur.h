...
namespace PM3D
{
	...
	public:
		...
		XMMATRIX GetMatView() { return m_camera->view(); }
		XMMATRIX GetMatProj() { return m_camera->proj; }
		XMMATRIX GetMatViewProj() { return m_camera->getViewProjMatrix(); }
       ...
       pirateSimulator::cameraModule::BaseCamera* getCamera() { return m_camera; }
	...
	{
        pirateSimulator::cameraModule::CameraProjectionParameters(XM_PI / 4, 1.0f, 30.0f, pDispositif->GetLargeur(), pDispositif->GetHauteur());


		// Initialisation des matrices View et Proj
		// Dans notre cas, ces matrices sont fixes
		m_camera = new pirateSimulator::cameraModule::FreeCamera(
            pirateSimulator::cameraModule::CameraProjectionParameters(XM_PI / 4, 1.0f, 30.0f, pDispositif->GetLargeur(), pDispositif->GetHauteur()),
            pirateSimulator::cameraModule::CameraMovingParameters(0.1f, 0.1f),
            XMMatrixLookAtLH(   XMVectorSet( 0.0f, 0.0f,-10.0f, 1.0f ),
