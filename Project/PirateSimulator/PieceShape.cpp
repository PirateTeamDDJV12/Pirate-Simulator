...
void PieceShape::setGameObject(GameObject* parent)
{
    ...
    m_actor = PhysicsManager::singleton.physics().createRigidDynamic(physx::PxTransform(PxVec3(parent->m_transform.m_position.vector4_f32[0], parent->m_transform.m_position.vector4_f32[1], parent->m_transform.m_position.vector4_f32[2])));
